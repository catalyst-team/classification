...
if [[ "$(uname)" == "Darwin" ]]; then
    ...
    sed -i ".bak" "s/logits: \&num_classes .*/logits: \&num_classes $NUM_CLASSES/g" ./configs/exp_splits_augs.yml
    sed -i ".bak" "s/class_rotation_logits: \&num_class_rotations .*/class_rotation_logits: \&num_class_rotations $NUM_CLASS_ROTATION/g" ./configs/exp_splits_augs.yml
    ...
    sed -i "s/logits: \&num_classes .*/logits: \&num_classes $NUM_CLASSES/g" ./configs/exp_splits_augs.yml
    sed -i "s/class_rotation_logits: \&num_class_rotations .*/class_rotation_logits: \&num_class_rotations $NUM_CLASS_ROTATION/g" ./configs/exp_splits_augs.yml
fi
